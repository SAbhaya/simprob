...
plotDice <- function(df){
  ...
  plot2 <- ggplot(df, aes(result, prop.table(df$Freq), fill = result)) + geom_bar(stat = "identity") + labs(title = paste0("Measured probability of Tossing a dice ", number," times"), y = "Probability") + theme(legend.position = "none")
